 ...
 * A zero-indexed array A consisting of N integers is given. A slice of that array is a pair of integers (P, Q) such that O ,; P,; Q < N. A slice {P, Q) of array A is called
 non-negative if all the elements A[P], A[P+ 1], ... , A[Q-1], A[Q] are non-negative. The sum of a slice (P, Q) of array A is the value A[P] + A(P+ 1] + ... + A[Q-1] +
 A[Q].
